	...
	public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
		...
		if (cmd.getName().equalsIgnoreCase("xp")) {
			...
			if (args[0].equalsIgnoreCase("add")) {
				try {
					XpAPI.addXp(t, tanto);
					p.sendMessage("§a§lXP §fVoc\u00ea adiconou §a§l" + tanto + " XP´s §fna §e§lCONTA §fdo jogador §7[§e"
							+ t.getName() + "§7]§f!");
				...
				try {
					...
					p.sendMessage("§a§lXP §fVoc\u00ea removeu §a§l" + tanto + " XP´s §fda §e§lCONTA §fdo jogador §7[§e"
							+ t.getName() + "§7]§f!");
