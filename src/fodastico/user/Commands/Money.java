        ...
        if (cmd.getName().equalsIgnoreCase("money")) {
            ...
            if (args[0].equalsIgnoreCase("add")) {
                try {
                    ...
                    p.sendMessage("§6§lMOEDAS §fVoc\u00ea adiconou §6§l" + tanto + " MOEDAS §fna §e§lCONTA §fdo jogador §7[§e" + t.getName() + "§7]§f!");
                    t.sendMessage("§6§lMOEDAS §fVoc\u00ea acabou de receber §6§l" + tanto + " MOEDAS §fna sua §e§lCONTA§f!");
                ...
                try {
                    ...
                    p.sendMessage("§6§lMOEDAS §fVoc\u00ea removeu §6§l" + tanto + " MOEDAS §fda §e§lCONTA §fdo jogador §7[§e" + t.getName() + "§7]§a.");
