...
public class Rank implements CommandExecutor
{
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (label.equalsIgnoreCase("rank")) {
            jogador.sendMessage("§6§lLIGA §fA nossa rede possui um sistema de liga \u00fanico que garante aos players uma competi\u00e7\u00e3o e mais destaque no servidor.");
            jogador.sendMessage("§fAo matar alg\u00faem, ganhar uma partida ou fazer a\u00e7\u00f5es espec\u00edficas de cada Modo de Jogo voc\u00ea recebe uma quantidade de XP calculada por nossa rede para upar de n\u00edvel.");
            ...
            jogador.sendMessage("§fXP necess\u00e1rio para a pr\u00f3xima liga: §4§l" + EventosGerais.XpNecessario(jogador));
            jogador.sendMessage("");
        }
        return false;
    }
