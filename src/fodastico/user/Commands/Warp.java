    ...
    public boolean onCommand(final CommandSender Sender, final Command Cmd, final String Label, final String[] Args) {
        ...
        if (Cmd.getName().equalsIgnoreCase("warp")) {
            ...
            if (Args[0].equalsIgnoreCase("fps")) {
                p.closeInventory();
                p.sendMessage("§3§lWARPS §fVoc\u00ea ser\u00e1 teleportado para a §9§lWARP §9§lFPS §fem §9§l5 SEGUNDOS...");
            ...
            if (Args[0].equalsIgnoreCase("pot")) {
                p.closeInventory();
                p.sendMessage("§3§lWARPS §fVoc\u00ea ser\u00e1 teleportado para a §9§lWARP §9§lPOT §fem §9§l5 SEGUNDOS...");
                Bukkit.getScheduler().scheduleSyncDelayedTask(Main.getPlugin(), (Runnable)new Runnable() {
                    @Override
                    public void run() {
                        p.setGameMode(GameMode.SURVIVAL);
                ...
                p.closeInventory();
                p.sendMessage("§3§lWARPS §fVoc\u00ea ser\u00e1 teleportado para a §9§lWARP §9§lTEXTURA §fem §9§l5 SEGUNDOS...");
                Bukkit.getScheduler().scheduleSyncDelayedTask(Main.getPlugin(), (Runnable)new Runnable() {
                    @Override
                    public void run() {
                        p.setGameMode(GameMode.SURVIVAL);
                ...
                if (EventoAPI.onEvent && !EventoAPI.closeEvent) {
                    ...
                    p.closeInventory();
                    p.sendMessage("§e§lEVENTO §fNenhum §6§lEVENTO §fest\u00e1 iniciando agora ou j\u00e1 possui um §6§lEVENTO §fem §a§lANDAMENTO§f!");
                }
            }
            else if (Args[0].equalsIgnoreCase("1v1")) {
                p.sendMessage("§3§lWARPS §fVoc\u00ea ser\u00e1 teleportado para a §9§lWARP §9§l1v1 §fem §9§l5 SEGUNDOS...");
                p.closeInventory();
                Bukkit.getScheduler().scheduleSyncDelayedTask(Main.getPlugin(), (Runnable)new Runnable() {
                    @Override
                    public void run() {
                ...
                p.sendMessage("§3§lWARPS §fVoc\u00ea ser\u00e1 teleportado para a §9§lWARP §9§lCHALLENGE §fem §9§l5 SEGUNDOS...");
                p.closeInventory();
                Bukkit.getScheduler().scheduleSyncDelayedTask(Main.getPlugin(), (Runnable)new Runnable() {
                    @Override
                    public void run() {
