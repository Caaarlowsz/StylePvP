		...
		if (cmd.getName().equalsIgnoreCase("cdoublexp")) {
			...
			if (args[0].equalsIgnoreCase("add")) {
				try {
					...
					p.sendMessage("§9§lDOUBLEXP §fVoc\u00ea adiconou §b§l" + tanto
							+ " DOUBLEXP(s) §fna §e§lCONTA §fdo jogador §7[§e" + t.getName() + "§7]§f!");
					t.sendMessage("§9§lDOUBLEXP §fVoc\u00ea acabou de receber §b§l" + tanto
							+ " DOUBLEXP(s) §fna sua §e§lCONTA§f!");
				...
				try {
					...
					p.sendMessage("§9§lDOUBLEXP §fVoc\u00ea removeu §b§l" + tanto
							+ " DOUBLEXP(s) §fda §e§lCONTA §fdo jogador §7[§e" + t.getName() + "§7]§a.");
