        ...
        if (Cmd.getName().equalsIgnoreCase("report")) {
            if (Args.length >= 2) {
                ...
                if (acusado != null) {
                    ...
                    p.sendMessage("§9§lREPORT §aVoc\u00ea reportou o(a) jogador(a) §7(§f" + acusado.getName() + "§7) §apor §7§(§e" + reportMsg + "§7)§a.");
                    ...
                    for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
                        ...
                        if (players.hasPermission("kitpvp.report")) {
                            ...
                            ChatInterativo.Comando(p.getName(), "§6§l[TELEPORT]", "/tp " + acusado.getName(), "§7(§cClique para teleportar ao acusado§7)");
                            players.sendMessage("");
