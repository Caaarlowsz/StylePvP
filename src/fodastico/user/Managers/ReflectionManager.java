...
public class ReflectionManager
{
    ...
    public ReflectionManager() {
        try {
            ...
            final Object obj = Bukkit.getServer().getClass().getDeclaredMethod("getServer", (Class<?>[])new Class[0]).invoke(Bukkit.getServer(), new Object[0]);
            this.propertyManager = obj.getClass().getDeclaredMethod("getPropertyManager", (Class<?>[])new Class[0]).invoke(obj, new Object[0]);
    ...
    public Object getPropertiesConfig(final String name, final Object obj) {
        try {
            final Properties properties = (Properties)this.propertyManager.getClass().getDeclaredField("properties").get(this.propertyManager);
    ...
    public void removeArrows(final Player player) {
        try {
            ...
            handle.invoke(player, new Object[0]).getClass().getMethod(methodName, Integer.TYPE).invoke(handle.invoke(player, new Object[0]), 0);
        }
        catch (Exception ex) {}
    }
    ...
    public void savePropertiesConfig() {
        try {
            this.propertyManager.getClass().getMethod("savePropertiesFile", (Class<?>[])new Class[0]).invoke(this.propertyManager, new Object[0]);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void sendChunk(final Player p, final int x, final int z) {
        try {
            final Object obj = p.getClass().getDeclaredMethod("getHandle", (Class<?>[])new Class[0]).invoke(p, new Object[0]);
            final List list = (List)obj.getClass().getField("chunkCoordIntPairQueue").get(obj);
            final Constructor con = Class.forName(String.valueOf(this.currentVersion) + ".ChunkCoordIntPair").getConstructor(Integer.TYPE, Integer.TYPE);
    ...
    public Object setPropertiesConfig(final String name, final Object obj) {
        try {
            return this.propertyManager.getClass().getMethod("a", String.class, Object.class).invoke(this.propertyManager, name, obj);
        }
        catch (Exception e) {
            e.printStackTrace();
            return obj;
    ...
    public void setWidthHeight(final Player p, final float height, final float width, final float length) {
        try {
            ...
            final Class c = Class.forName(String.valueOf(this.currentVersion) + ".Entity");
