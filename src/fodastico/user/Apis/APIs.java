...
public class APIs
{
    ...
    public static ItemStack criarItem(final Player p, final Material material, final String nome, final String[] lore, final int quantidade, final short cor) {
        final ItemStack item = new ItemStack(material, quantidade, cor);
        final ItemMeta kitem = item.getItemMeta();
        kitem.setDisplayName(nome);
        kitem.setLore((List)Arrays.asList(lore));
