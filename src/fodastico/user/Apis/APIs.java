...
public class APIs {
	public static void AutomaticMessage() {
		...
		case 1: {
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG1-LINE1").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG1-LINE2").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG1-LINE3").replace("&", "�"));
			break;
		}
		case 2: {
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG2-LINE1").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG2-LINE2").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG2-LINE3").replace("&", "�"));
			break;
		}
		case 3: {
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG3-LINE1").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG3-LINE2").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG3-LINE3").replace("&", "�"));
			break;
		}
		case 4: {
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG4-LINE1").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG4-LINE2").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG4-LINE3").replace("&", "�"));
			break;
		}
		case 5: {
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG5-LINE1").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG5-LINE2").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG5-LINE3").replace("&", "�"));
			break;
		}
		case 6: {
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG6-LINE1").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG6-LINE2").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG6-LINE3").replace("&", "�"));
			break;
		}
		case 7: {
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG7-LINE1").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG7-LINE2").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG7-LINE3").replace("&", "�"));
			break;
		}
		case 8: {
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG8-LINE1").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG8-LINE2").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG8-LINE3").replace("&", "�"));
			break;
		}
		case 9: {
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG9-LINE1").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG9-LINE2").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG9-LINE3").replace("&", "�"));
			break;
		}
		case 10: {
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG10-LINE1").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG10-LINE2").replace("&", "�"));
			Bukkit.broadcastMessage(StylePvP.getInstance().getConfig().getString("AUTO-MSG10-LINE3").replace("&", "�"));
			break;
		}
		}
	}
