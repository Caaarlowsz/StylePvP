...
public class Fast1v1 implements Listener
{
    ...
    public void onInteract2(final PlayerInteractEvent event) {
        ...
        if (!p.getItemInHand().equals((Object)Get1v1Itens.Lookingtry1) && !p.getItemInHand().equals((Object)Get1v1Itens.LookinTry2) && !p.getItemInHand().equals((Object)Get1v1Itens.Lookingtry3)) {
            return;
        }
        if (event.getAction() == Action.RIGHT_CLICK_BLOCK || (event.getAction() == Action.RIGHT_CLICK_AIR && Fast1v1.inSecondsWaiting.contains(p))) {
    ...
    public void onInteract(final PlayerInteractEvent event) {
        final Player p = event.getPlayer();
        if (p.getItemInHand().equals((Object)Get1v1Itens.SackFast) && (event.getAction() == Action.RIGHT_CLICK_BLOCK || event.getAction() == Action.RIGHT_CLICK_AIR)) {
