...
public class Menus implements Listener
{
    ...
    public static void inventorystatus(final Player p) {
        ...
        menu.setItem(10, newMenuItem(Material.ANVIL, "§b§lGRUPO: §7[§8" + EventosGerais.Grupo(p2) + "§7]", new String[0]));
        menu.setItem(11, newMenuItem(Material.DIAMOND_CHESTPLATE, "§6§lVIP: " + EventosGerais.SerVip(p2), new String[0]));
        ...
        menu.setItem(14, newMenuItem(Material.REDSTONE_BLOCK, "§b§lLIGA: " + EventosGerais.LigaAtual(p), new String[0]));
        menu.setItem(15, newMenuItem(Material.REDSTONE, "§2§lXP PARA PR\u00d3XIMA LIGA: §4§l" + EventosGerais.XpNecessario(p), new String[0]));
        menu.setItem(16, newMenuItem(Material.PAINTING, "§b§lNICK FORMAT ATUAL: " + p2.getDisplayName(), new String[0]));
    ...
    public void clickarstatus(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equals(p.getName()) && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            ...
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§b§lGRUPO: §7[§8" + EventosGerais.Grupo(p) + "§7]")) {
                e.setCancelled(true);
                return;
            }
            ...
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§6§lVIP: " + EventosGerais.SerVip(p))) {
                e.setCancelled(true);
                return;
            }
            ...
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§6§lMOEDAS: " + MoneyAPI.getMoney(p))) {
                e.setCancelled(true);
                return;
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§b§lLIGA: " + EventosGerais.LigaAtual(p))) {
                e.setCancelled(true);
                return;
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§2§lXP PARA PR\u00d3XIMA LIGA: §4§l" + EventosGerais.XpNecessario(p))) {
                e.setCancelled(true);
                return;
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§b§lNICK FORMAT ATUAL: " + p.getDisplayName())) {
                e.setCancelled(true);
                return;
            }
    ...
    public static void inventarioLojaPerm(final Player p) {
        ...
        menu.setItem(21, newMenuItem(Material.NAME_TAG, "§aAcesso §fao §7(§e/fly§7) '§fSOMENTE NO SPAWN' §f- §6§l[25000] Moedas!", new String[0]));
    ...
    public void clickarlojaperm(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§b§lLoja de §7(§cPERMISS\u00d5ES§7)") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§aAcesso §fao §7(§e/fly§7) '§fSOMENTE NO SPAWN' §f- §6§l[25000] Moedas!")) {
                final int moedas = MoneyAPI.getMoney(p);
                if (moedas < 25000) {
                    p.closeInventory();
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioLojaPerm(p) + " §6§lMOEDAS §cpara comprar esta §4§lPERMISS\u00c3O§c.");
                }
                else {
                    MoneyAPI.removeMoney(p, 25000);
                    p.closeInventory();
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + p.getName() + " add kitpvp.fly");
                    p.sendMessage("§3§lFLY §aVoc\u00ea agora possui permiss\u00e3o para voar no spawn!");
                }
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§5Resetar §4KD §f- §6§l[30000] Moedas!")) {
                final int moedas = MoneyAPI.getMoney(p);
                if (moedas < 30000) {
                    p.closeInventory();
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioLojaPermkd(p) + " §6§lMOEDAS §cpara comprar esta §4§lPERMISS\u00c3O§c.");
                }
                else {
                    ...
                    DeathAPI.saveDeath();
                    p.sendMessage("§3§lKD §aSeu kills/deaths foram resetados com sucesso! Caso n\u00e3o atualize na scoreboard, apenas relogue.");
                }
            }
        }
    }
    ...
    public void clickarlojakits(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§b§lLoja de Kits") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§aKit Gladiator §7- §6§l3.500 MOEDAS")) {
                final int moedas = MoneyAPI.getMoney(p);
                if (moedas < 3500) {
                    p.closeInventory();
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioGladiator(p) + " §6§lMOEDAS §cpara comprar este §b§lKIT§c.");
                }
                else {
                    MoneyAPI.removeMoney(p, 3500);
                    p.closeInventory();
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + p.getName() + " add kit.gladiator");
                    p.sendMessage("§3§lKIT §aVoc\u00ea comprou o kit gladiator com sucesso!");
                }
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§aKit Phantom §7- §6§l2.500 MOEDAS")) {
                final int moedas = MoneyAPI.getMoney(p);
                if (moedas < 2500) {
                    p.closeInventory();
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioPhantom(p) + " §6§lMOEDAS §cpara comprar este §b§lKIT§c.");
                }
                else {
                    MoneyAPI.removeMoney(p, 2500);
                    p.closeInventory();
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + p.getName() + " add kit.phantom");
                    p.sendMessage("§3§lKIT §aVoc\u00ea comprou o kit phantom com sucesso!");
                }
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§aKit Stomper §7- §6§l5.000 MOEDAS")) {
                final int moedas = MoneyAPI.getMoney(p);
                if (moedas < 5000) {
                    p.closeInventory();
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioStomper(p) + " §6§lMOEDAS §cpara comprar este §b§lKIT§c.");
                }
                else {
            ...
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§aKit AntStomper §7- §6§l3.000 MOEDAS")) {
                final int moedas = MoneyAPI.getMoney(p);
                if (moedas < 3000) {
                    p.closeInventory();
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioAntiStomper(p) + " §6§lMOEDAS §cpara comprar este §b§lKIT§c.");
                }
                else {
                    MoneyAPI.removeMoney(p, 3000);
                    p.closeInventory();
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + p.getName() + " add kit.antistomper");
                    p.sendMessage("§3§lKIT §aVoc\u00ea comprou o kit antistomper com sucesso!");
                }
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§aKit Viking §7- §6§l3.500 MOEDAS")) {
                final int moedas = MoneyAPI.getMoney(p);
                if (moedas < 3500) {
                    p.closeInventory();
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioViking(p) + " §6§lMOEDAS §cpara comprar este §b§lKIT§c.");
                }
                else {
                    MoneyAPI.removeMoney(p, 3500);
                    p.closeInventory();
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + p.getName() + " add kit.viking");
                    p.sendMessage("§3§lKIT §aVoc\u00ea comprou o kit viking com sucesso!");
                }
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§aKit Magma §7- §6§l2.500 MOEDAS")) {
                final int moedas = MoneyAPI.getMoney(p);
                if (moedas < 2500) {
                    p.closeInventory();
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioMagma(p) + " §6§lMOEDAS §cpara comprar este §b§lKIT§c.");
                }
                else {
                    MoneyAPI.removeMoney(p, 2500);
                    p.closeInventory();
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "pex user " + p.getName() + " add kit.magma");
    ...
    public void clickarshop(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§b§lShop") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            ...
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§bLoja de §7(§cPermiss\u00f5es§7)")) {
                e.setCancelled(true);
    ...
    public void clickarlojavip(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§b§lLoja de §7(§6Vips§7)") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
    ...
    public static void inventarioLojaVipserver(final Player p) {
        ...
        menu.setItem(19, newMenuItem(Material.DIAMOND_BLOCK, "§6§lVIP §7(§a§lLIGHT§7) §6§l[100000] Moedas §b& §a§l5000+ XPs", new String[0]));
        menu.setItem(22, newMenuItem(Material.DIAMOND_BLOCK, "§6§lVIP §7(§6§lPREMIUM§7) §6§l[200000] Moedas §b& §a§l10000+ XPs", new String[0]));
        menu.setItem(25, newMenuItem(Material.DIAMOND_BLOCK, "§6§lVIP §7(§d§lULTIMATE§7) §6§l[300000] Moedas §b& §a§l15000+ XPs", new String[0]));
        p.openInventory(menu);
    }
    ...
    public void clickarlojadevipinterna(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§bLoja §6§lVIP §7(§6INTERNA§7)") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§6§lVIP §7(§a§lLIGHT§7) §6§l[100000] Moedas §b& §a§l5000+ XPs")) {
                final int moedas = MoneyAPI.getMoney(p);
                final int xps = XpAPI.getXp(p);
                if (moedas < 100000 && xps < 5000) {
                    p.closeInventory();
                    p.sendMessage("§3§l        REQUISITOS INSUFICIENTES! ");
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioVipLight(p) + " §6§lMOEDAS §cpara comprar este §6§lVIP§c.");
                    p.sendMessage("§3§lXP §cVoc\u00ea precisa de mais §a§l" + EventosGerais.XpNecessarioVipLight(p) + " §a§lXPs §cpara comprar este §6§lVIP§c.");
                    p.sendMessage("§3§lREQUISITOS §cQuando possuir os 2 requisitos, voc\u00ea conseguir\u00e1 comprar!");
                }
                else {
                    MoneyAPI.removeMoney(p, 100000);
                    p.closeInventory();
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "grupo " + p.getName() + " light");
                    Bukkit.broadcastMessage("§3§lVIP §aO jogador §7(§f" + p.getName() + "§7) §aacabou de comprar um §6§lVIP §7(§a§lLIGHT§7) §ana loja de §6§lVIP §7(§eINTERNA§7)§a.");
                }
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§6§lVIP §7(§6§lPREMIUM§7) §6§l[200000] Moedas §b& §a§l10000+ XPs")) {
                final int moedas = MoneyAPI.getMoney(p);
                final int xps = XpAPI.getXp(p);
                if (moedas < 200000 && xps < 10000) {
                    p.closeInventory();
                    p.sendMessage("§3§l        REQUISITOS INSUFICIENTES! ");
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioVipPremium(p) + " §6§lMOEDAS §cpara comprar este §6§lVIP§c.");
                    p.sendMessage("§3§lXP §cVoc\u00ea precisa de mais §a§l" + EventosGerais.XpNecessarioVipPremium(p) + " §a§lXPs §cpara comprar este §6§lVIP§c.");
                    p.sendMessage("§3§lREQUISITOS §cQuando possuir os 2 requisitos, voc\u00ea conseguir\u00e1 comprar!");
                }
                else {
                    MoneyAPI.removeMoney(p, 200000);
                    p.closeInventory();
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "grupo " + p.getName() + " premium");
                    Bukkit.broadcastMessage("§3§lVIP §aO jogador §7(§f" + p.getName() + "§7) §aacabou de comprar um §6§lVIP §7(§6§lPREMIUM§7) §ana loja de §6§lVIP §7(§eINTERNA§7)§a.");
                }
            }
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§6§lVIP §7(§d§lULTIMATE§7) §6§l[300000] Moedas §b& §a§l15000+ XPs")) {
                final int moedas = MoneyAPI.getMoney(p);
                final int xps = XpAPI.getXp(p);
                if (moedas < 300000 && xps < 15000) {
                    p.closeInventory();
                    p.sendMessage("§3§l        REQUISITOS INSUFICIENTES! ");
                    p.sendMessage("§3§lMOEDAS §cVoc\u00ea precisa de mais §6§l" + EventosGerais.MoneyNecessarioVipUltimate(p) + " §6§lMOEDAS §cpara comprar este §6§lVIP§c.");
                    p.sendMessage("§3§lXP §cVoc\u00ea precisa de mais §a§l" + EventosGerais.XpNecessarioVipUltimate(p) + " §a§lXPs §cpara comprar este §6§lVIP§c.");
                    p.sendMessage("§3§lREQUISITOS §cQuando possuir os 2 requisitos, voc\u00ea conseguir\u00e1 comprar!");
                }
                else {
                    MoneyAPI.removeMoney(p, 300000);
                    p.closeInventory();
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "grupo " + p.getName() + " ultimate");
                    Bukkit.broadcastMessage("§3§lVIP §aO jogador §7(§f" + p.getName() + "§7) §aacabou de comprar um §6§lVIP §7(§d§lULTIMATE§7) §ana loja de §6§lVIP §7(§eINTERNA§7)§a.");
                }
            }
        }
    }
    ...
    public void clickarinventariomenuvip(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§6§lTAGS §b§lESPECIAIS") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            ...
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§b§lTAG §b§oGAMER")) {
                if (p.hasPermission("kitpvp.especial") || VipallAPI.vipall) {
                    ...
                    p.closeInventory();
                    p.sendMessage("§6§lTAGS §b§lESPECIAIS §fAjude o servidor adiquirindo §6§lVIP §fpara ter §e§lACESSO §f\u00e1s §b§lTAGS");
                }
            }
