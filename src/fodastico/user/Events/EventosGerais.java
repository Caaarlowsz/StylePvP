...
public class EventosGerais implements Listener
{
    ...
    public void onfakeJoin(final PlayerLoginEvent e) {
        ...
        for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
            ...
            if (jogador.getName().contains(jogadores.getName())) {
                e.disallow(PlayerLoginEvent.Result.KICK_OTHER, "§4§lONLINE \n \n §fJ\u00e1 §e§lPOSSUI §fum jogador §c§lONLINE §fcom este nick!");
            }
        }
    }
    ...
    public static void topks(final Player sender) {
        ...
        for (int i = 1; i < 2; ++i) {
            ...
            for (int length2 = (onlinePlayers2 = Bukkit.getOnlinePlayers()).length, k = 0; k < length2; ++k) {
                final Player jogadores2 = onlinePlayers2[k];
    ...
    public static void KillStreak(final Player player) {
        ...
        if (TopKsAPI.getStreak(killer) == 10) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 10");
        }
        else if (TopKsAPI.getStreak(killer) == 15) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 15");
        }
        else if (TopKsAPI.getStreak(killer) == 20) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 20");
        }
        else if (TopKsAPI.getStreak(killer) == 25) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 25");
        }
        else if (TopKsAPI.getStreak(killer) == 30) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 30");
        }
        else if (TopKsAPI.getStreak(killer) == 35) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 35");
        }
        else if (TopKsAPI.getStreak(killer) == 40) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 40");
        }
        else if (TopKsAPI.getStreak(killer) == 45) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 45");
        }
        else if (TopKsAPI.getStreak(killer) == 50) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 50");
        }
        else if (TopKsAPI.getStreak(killer) == 55) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 55");
        }
        else if (TopKsAPI.getStreak(killer) == 60) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 60");
        }
        else if (TopKsAPI.getStreak(killer) == 65) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 65");
        }
        else if (TopKsAPI.getStreak(killer) == 70) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 70");
        }
        else if (TopKsAPI.getStreak(killer) == 75) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 75");
        }
        else if (TopKsAPI.getStreak(killer) == 80) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 80");
        }
        else if (TopKsAPI.getStreak(killer) == 85) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 85");
        }
        else if (TopKsAPI.getStreak(killer) == 90) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 90");
        }
        else if (TopKsAPI.getStreak(killer) == 95) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 95");
        }
        else if (TopKsAPI.getStreak(killer) == 100) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 100");
        }
        else if (TopKsAPI.getStreak(killer) == 105) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 105");
        }
        else if (TopKsAPI.getStreak(killer) == 110) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 110");
        }
        else if (TopKsAPI.getStreak(killer) == 115) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 115");
        }
        else if (TopKsAPI.getStreak(killer) == 120) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 120");
        }
        else if (TopKsAPI.getStreak(killer) == 125) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 125");
        }
        else if (TopKsAPI.getStreak(killer) == 130) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 130");
        }
        else if (TopKsAPI.getStreak(killer) == 135) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 135");
        }
        else if (TopKsAPI.getStreak(killer) == 140) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 140");
        }
        else if (TopKsAPI.getStreak(killer) == 145) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 145");
        }
        else if (TopKsAPI.getStreak(killer) == 150) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 150");
        }
        else if (TopKsAPI.getStreak(killer) == 155) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 155");
        }
        else if (TopKsAPI.getStreak(killer) == 160) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 160");
        }
        else if (TopKsAPI.getStreak(killer) == 170) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 170");
        }
        else if (TopKsAPI.getStreak(killer) == 175) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 175");
        }
        else if (TopKsAPI.getStreak(killer) == 180) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 180");
        }
        else if (TopKsAPI.getStreak(killer) == 185) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 185");
        }
        else if (TopKsAPI.getStreak(killer) == 190) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 190");
        }
        else if (TopKsAPI.getStreak(killer) == 195) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 195");
        }
        else if (TopKsAPI.getStreak(killer) == 200) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 200");
        }
        else if (TopKsAPI.getStreak(killer) == 205) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 205");
        }
        else if (TopKsAPI.getStreak(killer) == 210) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 210");
        }
        else if (TopKsAPI.getStreak(killer) == 215) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 215");
        }
        else if (TopKsAPI.getStreak(killer) == 220) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 220");
        }
        else if (TopKsAPI.getStreak(killer) == 225) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 225");
        }
        else if (TopKsAPI.getStreak(killer) == 230) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 230");
        }
        else if (TopKsAPI.getStreak(killer) == 235) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 235");
        }
        else if (TopKsAPI.getStreak(killer) == 240) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 240");
        }
        else if (TopKsAPI.getStreak(killer) == 245) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 245");
        }
        else if (TopKsAPI.getStreak(killer) == 250) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 250");
        }
        else if (TopKsAPI.getStreak(killer) == 255) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 255");
        }
        else if (TopKsAPI.getStreak(killer) == 260) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 260");
        }
        else if (TopKsAPI.getStreak(killer) == 265) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 265");
        }
        else if (TopKsAPI.getStreak(killer) == 270) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 270");
        }
        else if (TopKsAPI.getStreak(killer) == 275) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 275");
        }
        else if (TopKsAPI.getStreak(killer) == 280) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 280");
        }
        else if (TopKsAPI.getStreak(killer) == 285) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 285");
        }
        else if (TopKsAPI.getStreak(killer) == 290) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 290");
        }
        else if (TopKsAPI.getStreak(killer) == 295) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 295");
        }
        else if (TopKsAPI.getStreak(killer) == 300) {
            Bukkit.getServer().broadcastMessage("§4§lKILLSTREAK §c§l" + killer.getName() + " §fconseguiu um §6§lKILLSTREAK DE 300");
        }
    }
    ...
    public void Whitelist(final PlayerLoginEvent e) {
        if (e.getResult() == PlayerLoginEvent.Result.KICK_WHITELIST) {
            e.disallow(PlayerLoginEvent.Result.KICK_OTHER, "§4§lMANUTEN\u00c7\u00c3O §fEstamos em §c§l§oMANUTEN\u00c7\u00c3O, §fpor isso voc\u00ea foi kickado!\n§fGarantimos que estamos §e§lTRABALHANDO §fpara um melhor §f§lSERVIDOR §fe enfim,\n§fpara sua melhor §a§lJOGABILIDADE");
        }
    }
    ...
    public static void MotdUpdate() {
        ...
        switch (random.nextInt(6)) {
            case 1: {
                EventosGerais.motdrandom = String.valueOf(Main.getInstance().getConfig().getString("AUTOMOTD-1-LINE1").replace("&", "§")) + "\n" + Main.getInstance().getConfig().getString("AUTOMOTD-1-LINE2").replace("&", "§");
                break;
            }
            case 2: {
                EventosGerais.motdrandom = String.valueOf(Main.getInstance().getConfig().getString("AUTOMOTD-2-LINE1").replace("&", "§")) + "\n" + Main.getInstance().getConfig().getString("AUTOMOTD-2-LINE2").replace("&", "§");
                break;
            }
            case 3: {
                EventosGerais.motdrandom = String.valueOf(Main.getInstance().getConfig().getString("AUTOMOTD-3-LINE1").replace("&", "§")) + "\n" + Main.getInstance().getConfig().getString("AUTOMOTD-3-LINE2").replace("&", "§");
                break;
            }
        }
    }
    ...
    public void MotdServidor(final ServerListPingEvent e) {
        ...
        if (Bukkit.hasWhitelist()) {
            e.setMotd("       §a§m    §a§m    §a§m    §f §l§m[§6 §lBATTLE§f§lBITS§f §l§m]§a§m    §a§m    §a§m     \n§f§lESTAMOS EM §4§lMANUTEN\u00c7\u00c3O §f§lPARA SUA MELHOR §e§lJOGABILIDADE");
        }
    }
}
