...
public class SubEventos implements Listener
{
    ...
    public void onChatFormat(final AsyncPlayerChatEvent e) {
        ...
        if (jogador.hasPermission("kitpvp.colorchat")) {
            e.setFormat(String.valueOf(jogador.getDisplayName()) + "§7: §f" + e.getMessage().replace("&", "§").replace("%", "%%"));
        }
        else {
            e.setFormat(String.valueOf(jogador.getDisplayName()) + "§7: " + e.getMessage().replace("%", "%%"));
        }
        if (!jogador.hasPermission("kitpvp.divulca\u00e7ao") && (e.getMessage().contains(".com.br") || e.getMessage().contains(".com") || e.getMessage().contains("mc.") || e.getMessage().contains("jogar.") || e.getMessage().contains(".tk") || e.getMessage().contains(".pro") || e.getMessage().contains(".net") || e.getMessage().contains(".play") || e.getMessage().contains("play.") || e.getMessage().contains("pvp.") || e.getMessage().contains("hg.") || e.getMessage().contains(".nu") || e.getMessage().contains(".mcnetwork") || e.getMessage().contains(".me") || e.getMessage().contains(".playbr.net") || e.getMessage().contains(".playbr") || e.getMessage().contains(".desirehost") || e.getMessage().contains(".virtus") || e.getMessage().contains(".host") || e.getMessage().contains(".br") || e.getMessage().contains(".server"))) {
            e.setCancelled(true);
            jogador.sendMessage("§b§lDIVULGA\u00c7AO §fVoc\u00ea n\u00e3o possui §4§lPERMISSAO §fpara §9§lDIVULGAR §fIP´s!");
        }
    }
    ...
    public void ssmessengerquit(final PlayerQuitEvent event) {
        final Player p = event.getPlayer();
        if (Ss.inss.contains(p)) {
            Bukkit.broadcastMessage("§4§lSCREENSHARE §fO jogador §1§l" + p.getName() + " §e§lDESLOGOU §fem §c§lSCREENSHARE");
            Ss.inss.remove(p);
        }
    }
    ...
    public void onPickup(final PlayerPickupItemEvent e) {
        final Player p = e.getPlayer();
        if (KitAPI.getkit(p) != "1v1" && e.getItem().getItemStack().getType() != Material.MUSHROOM_SOUP && e.getItem().getItemStack().getType() != Material.RED_MUSHROOM && e.getItem().getItemStack().getType() != Material.BROWN_MUSHROOM && e.getItem().getItemStack().getType() != Material.BOWL) {
            e.setCancelled(true);
        }
    ...
    public void onBreakCancell(final BlockBreakEvent e) {
        final Player p = e.getPlayer();
        if (Build.Build.get(p.getName()) == Build.BuilderMode.FALSE && e.getBlock().getType() != Material.BROWN_MUSHROOM && e.getBlock().getType() != Material.RED_MUSHROOM) {
            e.setCancelled(true);
        }
        ...
        if (p instanceof Player && e.getRightClicked() instanceof Player) {
            ...
            if (p.getItemInHand().getType() == Material.MUSHROOM_SOUP && AdminAPI.inAdmin.contains(p)) {
                ...
                if (AdminAPI.autoSoupChecking.contains(t)) {
                    p.sendMessage("§c§lADMIN §fOutro §d§lSTAFFER §fj\u00e1 est\u00e1 §e§lCHECANDO §fauto-soup neste jogador.");
                    return;
                }
                ...
                p.openInventory((Inventory)t.getInventory());
                t.getInventory().setItem(18, APIs.criarItem(p, Material.MUSHROOM_SOUP, "§cSopa", new String[] { "" }, 1, (short)0));
                t.getInventory().setItem(19, APIs.criarItem(p, Material.MUSHROOM_SOUP, "§cSopa", new String[] { "" }, 1, (short)0));
                t.getInventory().setItem(20, APIs.criarItem(p, Material.MUSHROOM_SOUP, "§cSopa", new String[] { "" }, 1, (short)0));
                t.getInventory().setItem(21, APIs.criarItem(p, Material.MUSHROOM_SOUP, "§cSopa", new String[] { "" }, 1, (short)0));
                t.getInventory().setItem(22, APIs.criarItem(p, Material.MUSHROOM_SOUP, "§cSopa", new String[] { "" }, 1, (short)0));
                t.getInventory().setItem(23, APIs.criarItem(p, Material.MUSHROOM_SOUP, "§cSopa", new String[] { "" }, 1, (short)0));
                t.getInventory().setItem(24, APIs.criarItem(p, Material.MUSHROOM_SOUP, "§cSopa", new String[] { "" }, 1, (short)0));
                t.getInventory().setItem(25, APIs.criarItem(p, Material.MUSHROOM_SOUP, "§cSopa", new String[] { "" }, 1, (short)0));
                t.getInventory().setItem(26, APIs.criarItem(p, Material.MUSHROOM_SOUP, "§cSopa", new String[] { "" }, 1, (short)0));
                p.sendMessage(" ");
                ...
                Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Main.getPlugin(), (Runnable)new Runnable() {
                    ...
                    public void run() {
                        if (SubEventos.getAmount(t, Material.BOWL) == 1) {
                            p.sendMessage(" ");
                            p.sendMessage("§c§lADMIN §fO jogador §c§lPROVAVELMENTE §fest\u00e1 de auto-soup! (1 sopa tomada)");
                        }
                        else if (SubEventos.getAmount(t, Material.BOWL) == 2) {
                            p.sendMessage(" ");
                            p.sendMessage("§c§lADMIN §fO jogador §c§lCERTAMENTE §fest\u00e1 de auto-soup! (2 sopas tomadas)");
                        }
                        else if (SubEventos.getAmount(t, Material.BOWL) == 3) {
                            p.sendMessage(" ");
                            p.sendMessage("§c§lADMIN §fO jogador §4§lDEFINITIVAMENTE §fest\u00e1 de auto-soup! (3 sopas tomadas)");
                        }
                        else if (SubEventos.getAmount(t, Material.BOWL) == 4) {
                            p.sendMessage(" ");
                            p.sendMessage("§c§lADMIN §fO jogador §4§lDEFINITIVAMENTE §fest\u00e1 de auto-soup! (4 sopas tomadas)");
                        }
                        else if (SubEventos.getAmount(t, Material.BOWL) >= 5) {
                            p.sendMessage(" ");
                            p.sendMessage("§c§lADMIN §fO jogador §4§lDEFINITIVAMENTE §fest\u00e1 de auto-soup! (5 sopas tomadas)");
                        }
                        else if (SubEventos.getAmount(t, Material.BOWL) == 0) {
                            p.sendMessage(" ");
                            p.sendMessage("§c§lADMIN §fO jogador §a§lN\u00c3O §fest\u00e1 de auto-soup! (0 sopas tomadas)");
                        }
    ...
    public void onStaffChatEvent(final AsyncPlayerChatEvent e) {
        ...
        if (Sc.inStaffChat.contains(p.getName())) {
            Bukkit.broadcast("§d[§d§lSTAFF§d] " + p.getDisplayName() + " §8» §e" + e.getMessage().replace("&", "§").replace("%", "%%"), "kitpvp.sc");
            e.setCancelled(true);
        }
    }
        ...
        if (e.getPlayer().getItemInHand().getType() == Material.COMPASS && KitAPI.getkit(e.getPlayer()) != "Spawn") {
            for (final Entity entidades : e.getPlayer().getNearbyEntities(100.0, 150.0, 100.0)) {
                if (entidades instanceof Player && e.getPlayer().getLocation().distance(entidades.getLocation()) >= 9.0) {
                    ...
                    e.getPlayer().sendMessage("§b§lBUSSOLA §fB\u00fassola apontando para §3§l" + ((Player)entidades).getName());
                    return;
                }
            }
            if (!parar) {
    ...
    public static void sendMsg(final Player p) {
        if (p.isOnline()) {
            p.sendMessage("§9§lDOUBLEXP §fVoc\u00ea saiu de §c§lCOOLDOWN§f! Se quiser, j\u00e1 pode §a§lUSAR§f outro §b§lDOUBLEXP §fnovamente caso ainda possua!");
        }
    }
}
