...
public class KitEvents implements Listener
{
    public static void onOpenInvKits(final Player p) {
        ...
        if (p.hasPermission("kit.pvp") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.DIAMOND_SWORD, "§b§lPvP", new String[] { "§fO velho kitpvp", "§fcom espada afiada 1" }) });
        }
        if (p.hasPermission("kit.kangaroo") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.FIREWORK, "§b§lKangaroo", new String[] { "§fPule, corra ou suba por a\u00ed", "§fcom o seu foguete" }) });
        }
        if (p.hasPermission("kit.quickdropper") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.BOWL, "§b§lQuickdropper", new String[] { "§fAo tomar uma sopa", "§fo pote dropar\u00e1 autom\u00e1ticamente" }) });
        }
        if (p.hasPermission("kit.snail") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.SOUL_SAND, "§b§lSnail", new String[] { "§fAo hitar um jogador, ter\u00e1 40% de", "§fchance dele receber lentid\u00e3o" }) });
        }
        if (p.hasPermission("kit.fisherman") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.FISHING_ROD, "§b§lFisherman", new String[] { "§fAo fisgar um jogador com sua vara", "§fpuxe-o at\u00e9 voc\u00ea" }) });
        }
        if (p.hasPermission("kit.stomper") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.LEATHER_BOOTS, "§b§lStomper", new String[] { "§fPule de uma altura em cima de seus inimigos", "§fpara esmag\u00e1los e mat\u00e1-los automaticamente" }) });
        }
        if (p.hasPermission("kit.switcher") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.SNOW_BALL, "§b§lSwitcher", new String[] { "§fAo lan\u00e7ar bolinhas de neve em um jogador", "§fele trocar\u00e1 de lugar com voc\u00ea" }) });
        }
        if (p.hasPermission("kit.anchor") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.ANVIL, "§b§lAnchor", new String[] { "§fN\u00e3o d\u00ea e nem leve", "§fknockback ao hitar um jogador" }) });
        }
        if (p.hasPermission("kit.gladiator") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.IRON_FENCE, "§b§lGladiator", new String[] { "§fAo utilizar sua grade de ferro em um jogador", "§fvoces ser\u00e3o teleportados \u00e1 uma arena fechada para x1" }) });
        }
        if (p.hasPermission("kit.critical") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.COAL_BLOCK, "§b§lCritical", new String[] { "§fAo hitar um jogador tenha 40% de", "§fchance de um dano cr\u00edtico" }) });
        }
        if (p.hasPermission("kit.viper") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.SPIDER_EYE, "§b§lViper", new String[] { "§fAo hitar um jogador tenha 40% de", "§fchance dele receber efeito de veneno" }) });
        }
        if (p.hasPermission("kit.antistomper") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.DIAMOND_BOOTS, "§b§lAntiStomper", new String[] { "§fN\u00e3o morra stompado" }) });
        }
        if (p.hasPermission("kit.poseidon") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.WATER_BUCKET, "§b§lPoseidon", new String[] { "§fQuando voc\u00ea estiver a \u00e1gua", "§ffique mais forte e mais perigoso" }) });
        }
        if (p.hasPermission("kit.sniper") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.BONE, "§b§lSniper", new String[] { "§fTenha um arco e flecha", "§fpara atirar e dar dano nos inimigos" }) });
        }
        if (p.hasPermission("kit.phantom") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.FEATHER, "§b§lPhantom", new String[] { "§fAo usar sua pena, voc\u00ea ganhar\u00e1", "§fhabilidade de voar" }) });
        }
        if (p.hasPermission("kit.specialist") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.BOOK, "§b§lSpecialist", new String[] { "§fA cada kill, ganhe xp", "§fpara encantar sua espada" }) });
        }
        if (p.hasPermission("kit.hotpotato") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.TNT, "§b§lHotPotato", new String[] { "§fColoque TNT na cabe\u00e7a dos jogadores", "§fe explodir\u00e1 em 3 segundos" }) });
        }
        if (p.hasPermission("kit.imortal") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.BEDROCK, "§b§lImortal", new String[] { "§fFique completamente imortal", "§fpor 30 segundos!" }) });
        }
        if (p.hasPermission("kit.viking") || VipallAPI.vipall) {
            inv.addItem(new ItemStack[] { newMenuItem(Material.DIAMOND_AXE, "§b§lViking", new String[] { "§fCom seu machado de diamente", "§fde um dano de uma espada de diamante afiada 3" }) });
        }
        p.openInventory(inv);
    }
    ...
    public static void MenuWarpFPS(final Player p) {
        ...
        inv.setItem(22, newMenuItem(Material.DIAMOND_BLOCK, "§6§lWARP FPS", new String[] { "§b§lUTILIDADE §fEsta §9§lWARP §fse", "§fconsiste em dar mais §3§lFPS §fpara", "§fos jogadores tirarem §e§lPVP" }));
        p.openInventory(inv);
    }
    ...
    public void ClickarMWarpFps(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equals("§fInfo §9§lWARP FPS") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
    ...
    public static void MenuWarpCHALLENGE(final Player p) {
        ...
        inv.setItem(22, newMenuItem(Material.DIAMOND_BLOCK, "§6§lWARP CHALLENGE", new String[] { "§b§lUTILIDADE §fEsta §9§lWARP §ffoi feita", "§fpara jogadores que querem treinar suas habilidades", "§fem tomar sopa ou farmar §6§lMOEDAS", "§fe §a§lXP's §fmais r\u00e1pido." }));
        p.openInventory(inv);
    }
    ...
    public void ClickarMWarpChallenge(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§fInfo §9§lWARP CHALLENGE") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getType() == Material.DIAMOND_BLOCK) {
                e.setCancelled(true);
                p.closeInventory();
    ...
    public static void MenuWarpTEXTURA(final Player p) {
        ...
        inv.setItem(22, newMenuItem(Material.DIAMOND_BLOCK, "§6§lWARP TEXTURA", new String[] { "§b§lUTILIDADE §fUma §9§lWARP §fsimples,", "§ffeita por nossos §2§lBUILDERS §fpara voc\u00ea conhecer", "§fmelhor e testar suas texturas." }));
        p.openInventory(inv);
    }
    ...
    public void ClickarMWarpTextura(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§fInfo §9§lWARP TEXTURA") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getType() == Material.DIAMOND_BLOCK) {
                e.setCancelled(true);
                p.closeInventory();
    ...
    public static void MenuWarp1v1(final Player p) {
        ...
        inv.setItem(22, newMenuItem(Material.DIAMOND_BLOCK, "§6§lWARP 1v1", new String[] { "§b§lUTILIDADE §fEsta §9§lWARP §ffoi feita especialmente para", "§fos jogadores que gostam de ir pvp justo,", "§fupar de ligas, treinar etc." }));
        p.openInventory(inv);
    }
    ...
    public void ClickarMWarp1v1(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equals("§fInfo §9§lWARP 1v1") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getType() == Material.DIAMOND_BLOCK) {
                e.setCancelled(true);
                p.closeInventory();
    ...
    public void onKitClick(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equalsIgnoreCase("§3§lSELETOR DE KITS") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getType() == Material.DIAMOND_SWORD) {
                e.setCancelled(true);
                KitAPI.setKit(p, "PvP");
                KitAPI.setDefaultItens(p);
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
            ...
            if (e.getCurrentItem().getType() == Material.FEATHER) {
                ...
                p.getInventory().setItem(1, APIs.criarItem(p, Material.FEATHER, ChatColor.GREEN + "Phantom", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
            ...
            if (e.getCurrentItem().getType() == Material.IRON_FENCE) {
                ...
                p.getInventory().setItem(1, APIs.criarItem(p, Material.IRON_FENCE, ChatColor.GREEN + "Gladiator", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
            ...
            if (e.getCurrentItem().getType() == Material.TNT) {
                ...
                p.getInventory().setItem(1, APIs.criarItem(p, Material.TNT, ChatColor.GREEN + "HotPotato", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
            ...
            if (e.getCurrentItem().getType() == Material.BEDROCK) {
                ...
                p.getInventory().setItem(1, APIs.criarItem(p, Material.BEDROCK, ChatColor.GREEN + "Imortalidade", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
            ...
            if (e.getCurrentItem().getType() == Material.DIAMOND_AXE) {
                ...
                p.getInventory().setItem(0, APIs.criarItem(p, Material.DIAMOND_AXE, ChatColor.GREEN + "Viking", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
            ...
            if (e.getCurrentItem().getType() == Material.IRON_INGOT) {
                ...
                p.getInventory().setItem(1, APIs.criarItem(p, Material.WORKBENCH, ChatColor.GREEN + "IronMan", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
            ...
            if (e.getCurrentItem().getType() == Material.WOOD_AXE) {
                ...
                p.getInventory().setItem(1, APIs.criarItem(p, Material.WOOD_AXE, ChatColor.GREEN + "Thor", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
            ...
            if (e.getCurrentItem().getType() == Material.FIREWORK) {
                ...
                p.getInventory().setItem(1, APIs.criarItem(p, Material.FIREWORK, ChatColor.GREEN + "Kangaroo", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
            ...
            if (e.getCurrentItem().getType() == Material.BOOK) {
                ...
                p.getInventory().setItem(1, APIs.criarItem(p, Material.BOOK, ChatColor.GREEN + "Specialist", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
            ...
            if (e.getCurrentItem().getType() == Material.FISHING_ROD) {
                ...
                p.getInventory().setItem(1, APIs.criarItem(p, Material.FISHING_ROD, ChatColor.GREEN + "Fisherman", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
            ...
            if (e.getCurrentItem().getType() == Material.SNOW_BALL) {
                ...
                p.getInventory().setItem(1, APIs.criarItem(p, Material.SNOW_BALL, ChatColor.GREEN + "Switcher", new String[1], 64, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.closeInventory();
                TituloAPI.MandarTitulo(p, "§e§lSWITCHER");
                p.sendMessage("§3§lKIT §fVoc\u00ea selecionou o §b§lKIT §e§lSWITCHER");
                p.sendMessage("§3§lSWITCHER §fDeixe um espa\u00e7o no seu §e§lINVENTARIO §fpara receber mais §b§lBOLAS DE NEVE§f!");
                return;
            }
            if (e.getCurrentItem().getType() == Material.ARROW) {
                ...
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.getInventory().setItem(1, APIs.criarItem(p, Material.BOW, ChatColor.GREEN + "Arco", new String[1], 1, (short)0));
                p.getInventory().setItem(8, APIs.criarItem(p, Material.COMPASS, ChatColor.GREEN + "Bussola", new String[1], 1, (short)0));
                p.getInventory().setItem(20, APIs.criarItem(p, Material.ARROW, ChatColor.GREEN + "Flechas", new String[1], 30, (short)0));
                p.closeInventory();
