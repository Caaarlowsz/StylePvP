...
public class Placas implements Listener
{
    ...
    public void Recraft(final SignChangeEvent e) {
        ...
        if (p.hasPermission("kitpvp.placa") && e.getLine(0).equalsIgnoreCase("recraft")) {
            e.setLine(0, Main.getInstance().getConfig().getString("MSG-PLACA-RECRAFT-1").replace("&", "§"));
            e.setLine(2, Main.getInstance().getConfig().getString("MSG-PLACA-RECRAFT-2").replace("&", "§"));
            e.setLine(3, Main.getInstance().getConfig().getString("MSG-PLACA-RECRAFT-3").replace("&", "§"));
    ...
    public void InvRecraft(final PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && ((e.getClickedBlock() != null && e.getClickedBlock().getType() == Material.WALL_SIGN) || e.getClickedBlock().getType() == Material.SIGN_POST)) {
            ...
            if (lines.length > 0 && lines[0].equals(Main.getInstance().getConfig().getString("MSG-PLACA-RECRAFT-1").replace("&", "§")) && lines.length > 2 && lines[2].equals(Main.getInstance().getConfig().getString("MSG-PLACA-RECRAFT-2").replace("&", "§")) && lines.length > 3 && lines[3].equals(Main.getInstance().getConfig().getString("MSG-PLACA-RECRAFT-3").replace("&", "§"))) {
    ...
    public void Sopas(final SignChangeEvent e) {
        ...
        if (p.hasPermission("kitpvp.placa") && e.getLine(0).equalsIgnoreCase("sopa")) {
            e.setLine(0, Main.getInstance().getConfig().getString("MSG-PLACA-SOPA-1").replace("&", "§"));
            e.setLine(2, Main.getInstance().getConfig().getString("MSG-PLACA-SOPA-2").replace("&", "§"));
            e.setLine(3, Main.getInstance().getConfig().getString("MSG-PLACA-SOPA-3").replace("&", "§"));
    ...
    public void InvSopas(final PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && ((e.getClickedBlock() != null && e.getClickedBlock().getType() == Material.WALL_SIGN) || e.getClickedBlock().getType() == Material.SIGN_POST)) {
            final Sign s = (Sign)e.getClickedBlock().getState();
            final String[] lines = s.getLines();
            if (lines.length > 0 && lines[0].equals(Main.getInstance().getConfig().getString("MSG-PLACA-SOPA-1").replace("&", "§")) && lines.length > 2 && lines[2].equals(Main.getInstance().getConfig().getString("MSG-PLACA-SOPA-2").replace("&", "§")) && lines.length > 3 && lines[3].equals(Main.getInstance().getConfig().getString("MSG-PLACA-SOPA-3").replace("&", "§"))) {
